...
RUN importrdf -Dgraphdb.home.data=/opt/graphdb/home/data load -c ${GRAPHDB_IMPORT}/graphdb-repo-config-one-million.ttl -m parallel ${GRAPHDB_IMPORT}/two-million.nt 
